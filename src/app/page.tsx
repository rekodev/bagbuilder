...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 py-20">
      ...
      <section className="bg-gray-50 dark:bg-gray-900 py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="grid gap-10 sm:grid-cols-3 mt-8">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/discs">Explore Discs</Link>
              </Button>
            </div>
          </div>
        </div>

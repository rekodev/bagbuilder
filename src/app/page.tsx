...
import { ArrowRight, Disc2, ShoppingBag, Sparkles } from 'lucide-react';
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="bg-primary rounded-full p-3">
                <Disc2 className="text-primary-foreground h-10 w-10" />
              </div>
              <div className="space-y-2">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="bg-primary rounded-full p-3">
                <ShoppingBag className="text-primary-foreground h-10 w-10" />
              </div>
              <div className="space-y-2">
      ...
      <section className="bg-accent py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Button asChild size="lg">
                <Link href={Page.SignUp}>Sign Up Free</Link>
              </Button>
              <Button asChild variant="outline" size="lg">
